...
const BotName = 'ESTER - DARK GOSTOSO'; 
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("lixo")){
			client.updatePresence(from, Presence.composing)
			reply("a gorda da sua mãe essa puta")
	}
...
// recursos anime, random @DARK domina irmão
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMIN BOT ESTER - DARK GOSTOSO 🇧🇷* 」\n*│+ wa.me/5521982310081*╰──────*「 *DARK GOSTOSO* 」*────*\n\n*_SE QUER SER ADMIN DO BOT ESTER_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* DARK GOSTOSO\n*YOUTUBE:* \n*WPP:* wa.me/+5521982310081\n*INSTA:* sai\n\n\nEspero que tenham gostado do bot 🐒🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
